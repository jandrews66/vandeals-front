...
export default function DealForm({ onSubmit, initialData = {} }){
    ...
    const [restaurantAddress, setRestaurantAddress] = useState(initialData.address || '');
    const [description, setDescription] = useState(initialData.description || '');
    const [startDate, setStartDate] = useState(initialData.start_date || '');
    const [endDate, setEndDate] = useState(initialData.end_date || '');
    const [days, setDays] = useState(initialData.days || []);
    const [coords, setCoords] = useState(initialData?.location?.coordinates || []);
    const [timePeriods, setTimePeriods] = useState(initialData.time_periods || []);
